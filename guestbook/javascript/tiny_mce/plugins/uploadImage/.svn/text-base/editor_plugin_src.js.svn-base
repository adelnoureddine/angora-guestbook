	...
	tinymce.create('tinymce.plugins.UploadImagePlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceUploadImage', function() {
				ed.windowManager.open({
					...
					file : 'http://aguestbook.sourceforge.net/cloud/dialog.html',
					width : 320 + parseInt(ed.getLang('uploadImage.delta_width', 0)),
					height : 320 + parseInt(ed.getLang('uploadImage.delta_height', 0)),
					inline : 1
				}, {
		...
		getInfo : function() {
			return {
				...
				authorurl : 'http://aguestbook.sourceforge.net',
				infourl : 'http://aguestbook.sourceforge.net',
				version : "1.0"
			};
		}
	});
